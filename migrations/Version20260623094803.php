 ...
 */
final class Version20260623094803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game_resource_deposit ADD building_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F66ABDCD4D2A7E12 ON game_resource_deposit (building_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_F66ABDCD4D2A7E12 ON game_resource_deposit');
        $this->addSql('ALTER TABLE game_resource_deposit DROP building_id');
