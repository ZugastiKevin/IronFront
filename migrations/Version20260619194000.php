 ...
 */
final class Version20260619194000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX idx_building_game_user ON building (game_id, user_id)');
        $this->addSql('ALTER TABLE building RENAME INDEX idx_e16f61d4e48fd905 TO idx_building_game');
        $this->addSql('ALTER TABLE building RENAME INDEX idx_e16f61d4a76ed395 TO idx_building_user');
        ...
        $this->addSql('CREATE INDEX idx_game_status ON delivery (game_id, status)');
        $this->addSql('CREATE INDEX idx_game_scheduled_at ON delivery (game_id, scheduled_at)');
        $this->addSql('CREATE INDEX idx_game_created_at ON delivery (game_id, created_at)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX idx_building_game_user ON building');
        $this->addSql('ALTER TABLE building RENAME INDEX idx_building_game TO IDX_E16F61D4E48FD905');
        $this->addSql('ALTER TABLE building RENAME INDEX idx_building_user TO IDX_E16F61D4A76ED395');
        ...
        $this->addSql('DROP INDEX idx_game_status ON delivery');
        $this->addSql('DROP INDEX idx_game_scheduled_at ON delivery');
        $this->addSql('DROP INDEX idx_game_created_at ON delivery');
