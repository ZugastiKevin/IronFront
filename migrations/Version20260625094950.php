 ...
 */
final class Version20260625094950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE resource_image (id INT AUTO_INCREMENT NOT NULL, image_path VARCHAR(191) NOT NULL, resource_type_id INT NOT NULL, INDEX IDX_EE867E6D98EC6B7B (resource_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE resource_image');
