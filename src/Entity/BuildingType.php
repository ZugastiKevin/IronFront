...
class BuildingType
{
    ...
    public function setCategory(BuildingCategory $category): static
    {
    ...
    {
        return $this->category === BuildingCategory::PRODUCTION;
    }

    public function isMilitary(): bool
    {
        return $this->category === BuildingCategory::MILITARY;
    }

    public function isStorage(): bool
    {
        return $this->category === BuildingCategory::STORAGE;
    }

    public function isBase(): bool
    {
        return $this->category === BuildingCategory::BASE;
    }

    public function isDefense(): bool
    {
        return $this->category === BuildingCategory::DEFENSE;
    }

    public function isResearch(): bool
    {
        return $this->category === BuildingCategory::RESEARCH;
    }

    public function isTrade(): bool
    {
        return $this->category === BuildingCategory::TRADE;
    }

    public function isCategory(BuildingCategory $category): bool
    {
