...
use App\Service\UserGameInitializer;
...
final class GameController extends AbstractController
{
    ...
    public function index(BuildingRepository $buildingRepo, BuildingTypeRepository $buildingTypeRepo,): Response
    {
        $user = $this->getUser();
        ...
        $hasBase = $buildingRepo->findBaseForUser($game, $user) !== null;
    ...
    public function chooseFaction(Request $request, EntityManagerInterface $entityManager, UserGameInitializer $userGameInitializer, GameRepository $gameRepository
    ): Response {
        $user = $this->getUser();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $userGameInitializer->initialize($user);
